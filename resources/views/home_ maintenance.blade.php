...
<head>
    ...
    <meta name="csrf-token" content="8kCh6NBaFVuWyT4v1PFAFX5qFaE3hppc1SnScstF">
    <link rel="icon" href="https://my-traders.com/storage/img/icon.png" type="image/x-icon">
    ...
    <link rel="stylesheet" href="/css/auth_old.css">
    <title>Для Людей | Калькулятор</title>
</head>
<body>
<div class="header">
    <div class="header_center_wrap">
        <div class="logo">
            <img src="https://my-traders.com/storage/img/logo.png" alt="logo">
        </div>
        ...
        <div class="nav">
            ...
            <div class="mobile_btn">
                <a href="/" class="tg">
                    <img src="https://my-traders.com/storage/img/icon_tg.png" alt="tg"></a>
                <img src="https://my-traders.com/storage/img/icon_language.png" alt="lang">
        ...
        <div class="right_btns">
            <div class="item">
                <a href="https://t.me/my_traders" class="tg">
                    <img class="icon_tg" src="https://my-traders.com/storage/img/icon_tg.png" alt="tg">
                </a>
                <img src="https://my-traders.com/storage/img/icon_language.png" alt="language">
            </div>


            <div class="burger" onclick="tongle_burger('open')">
                <img src="https://my-traders.com/storage/img/burger_menu.png" alt="burger menu">
            </div>

            <div class="burger_close" onclick="tongle_burger('close')">
                <img src="https://my-traders.com/storage/img/burber_close.png" alt="burger menu">
            </div>
...
<div class="m_wrap">
    <div class="center_wrap">
        ...
        <div class="results">
            <div class="title_center_cont_res">
                ...
                <img src="https://my-traders.com/storage/img/arrow_long.png" id="res_arrow_up" class="res_arrow" alt="long">
                <img src="https://my-traders.com/storage/img/arrow_short.png" id="res_arrow_down" class="ord_wrap_hidn" alt="short">
            </div>
            ...
            <div id='calc_result'>
                ...
                <a  class="btn_save_public" id="btn_save_order" href="/" >
                    Сохранить сделку
                </a>
            </div>
        ...
        <div class="stat">
            ...
            <div class="public_calc_glassmorh">
                ...
                <div class="btns">
                    <a class='go_log' href="/" >Авторизация</a>
                    <a class = 'go_reg' href="/">Регистрация</a>
                </div>
            </div>
            <div class="stat_wrap">
    ...
    <div class="signals">
        <div class="first">
            ...
            <div class="right">
                <img src="https://my-traders.com/storage/img/icon_tg.png" alt="tg">
        ...
        <div class="second">
            ...
            <img src="https://my-traders.com/storage/img/signals.png" alt="signals">
        </div>
        <div class="third">
        ...
        <div class="footer_center_wrap">
            <div class="first_wrap">
                ...
                <div class="nav">
                    ...
                    <a href="/" class="link">Сигналы</a>
                    <a href="/" class="link">Статистика</a>
                    <a href="/" class="link">Калькулятор</a>
                    <a href="/" class="link">Образование</a>
                </div>
                <div class="right_btns">
                    <div class="item">
                        <img class="icon_tg" src="https://my-traders.com/storage/img/icon_tg.png" alt="tg">
                        <img src="https://my-traders.com/storage/img/icon_language.png" alt="langiage">
                    </div>
                    <div class="item_2">
                        <img src="https://my-traders.com/storage/img/icon_profile.png" alt="profile">
                        <img src="https://my-traders.com/storage/img/icon_exit.png" alt="exit">
                    </div>
                </div>
            </div>
