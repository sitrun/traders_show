<x-app-layout>
    ...
    <script>
        var orders = {{ Js::from($data['orders']) }};
        var user_info = {{ Js::from($data['user_info']) }};
        var user_id = {{  Js::from($data['user_id']) }};
        var forex = {{  Js::from($data['forex']) }};
        var top20 = {{  Js::from($data['top20']) }};

        var btn_img_del = "{{ asset('storage/img/del.png') }}";
        var arrow_long_img = "{{ asset('storage/img/arrow_long.png') }}";
        var arrow_short_img = "{{ asset('storage/img/arrow_short.png') }}";
    </script>
...
<div class="m_wrap">
    <div class="center_wrap">
                ...
                <div id="forex_wrap" class="calc_input_disactive">
                    <div class="line">
                        ...
                        <div class="line_item">
                            ...
                            <select id="forex_chose_paire" class="select" onchange="calc_forex()">
                ...
                <div id="crypto_wrap" class="calc_input_active">
                    <div class="line">
                        ...
                        <div class="line_item">
                            ...
                            <select id="crypto_chose_symbol" onchange="calc_crypto()">
            ...
            <div id='calc_result'>
                ...
                <div id="crypto_res_wrap" class="disactive_res">
                    ...
                    <div class="res_item gray_line">
                        ...
                        <div class='f_res_tp_price_wrap'>
                            <div class="f_res_tp_price_item">
                                <p class="f_res_tp" id="crypto_res_tp_price"></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="res_item">
                        ...
                        <div class='f_res_tp_price_wrap' id= 'f_res_tp_crypto_price_wrap'>
                ...
                <div class="bottom_btns_save_order">
                    <div data-name="Система автоматически отслеживает Ваши сделки и проводит анализ статистики" id='mode_auto' onclick="change_save_mode('mode_auto','mode_hand')">Автоматически</div>
                    <div data-name='Вы сами активируете сделку на портале, самостоятельно отслеживаете результат и выбираете "Тейк" или "Стоп"' id="mode_hand" onclick="change_save_mode('mode_hand','mode_auto')">Вручную</div>
                    <a  class="btn_save" id="btn_save_order" data-form_custom="#create_order_form">
                        <img src="{{ asset('storage/img/save.png') }}" alt="save_order" width="25">
                    </a>
                    <form action="" id="create_order_form">
                        <input type="hidden" name="user_id" value="">
                        <input type="hidden" name="market" value="">
                        <input type="hidden" name="date" value="">
                        <input type="hidden" name="time" value="">
                        <input type="hidden" name="dep" value="">
                        <input type="hidden" name="risk" value="">
                        <input type="hidden" name="paire" value="">
                        <input type="hidden" name="symbol" value="">
                        <input type="hidden" name="open" value="">
                        <input type="hidden" name="stop" value="">
                        <input type="hidden" name="pips" value="">
                        <input type="hidden" name="valume" value="">
                        <input type="hidden" name="bay_on" value="">
                        <input type="hidden" name="tp_price" value="">
                        <input type="hidden" name="risk_money" value="">
                        <input type="hidden" name="cur" value="">
                        <input type="hidden" name="credit" value="">
                        <input type="hidden" name="lot" value="">
                        <input type="hidden" name="tp_money" value="">
                        <input type="hidden" name="multiplier" value="">
                        <input type="hidden" name="status" value="">
                        <input type="hidden" name="type_order" value="">
                        <input type="hidden" name="mode" value="">
                        <input type="hidden" name="date_die" value="">
                        <input type="hidden" name="style_trade" value="">
                    </form>
                </div>

                <div class="time_cancel_order">
                    <div class="title">Отмена сделки:</div>
                    <div id='rc_24' class="item active" onclick="change_time_order_life('rc_24')">24ч.</div>
                    <div id='rc_48' class="item" onclick="change_time_order_life('rc_48')">48ч.</div>
                    <div id='rc_week' class="item" onclick="change_time_order_life('rc_week')">Неделя</div>
                    <div id='rc_mounth' class="item" onclick="change_time_order_life('rc_mounth')">Месяц</div>
                </div>
        ...
        <div class="stat">
            <div class="stat_wrap_title">
                ...
                <select id="chose_stat_time" onchange="stat_filter()">
                    <option value="all_time">Всё время</option>
                    <option value="1_hourse">За час</option>
                    <option value="12_hourse">12 часов</option>
                    <option value="24_hourse">24 часа</option>
                    <option value="1_week">Неделя</option>
                    <option value="1_mounth">Месяц</option>
                    <option value="3_mounth">3 месяца</option>
            ...
            <div class="stat_wrap">
                <div class="stat_line gray_line">
                    ...
                    <p id="stat_total" class="stat_text_right"></p>
                </div>
                <div class="stat_line">
                    <p class="title">Средний депозит:</p>
                    <p id="stat_dep" class="stat_text_right"></p>
                </div>
                <div class="stat_line gray_line">
                    <p class="title">Средний % риска:</p>
                    <p id="stat_risk" class="stat_text_right"></p>
                </div>
                <div class="stat_line">
                    <p class="title">Long-сделки:</p>
                    <p id="stat_long" class="stat_text_right"></p>
                </div>
                <div class="stat_line gray_line">
                    <p class="title">Short-сделки:</p>
                    <p id="stat_short" class="stat_text_right"></p>
                </div>
                <div class="stat_line">
                    <p class="title">Прибыльные:</p>
                    <p id="stat_profit" class="stat_text_right"></p>
                </div>
                <div class="stat_line gray_line">
                    <p class="title">Убыточные:</p>
                    <p id="stat_loss" class="stat_text_right"></p>
                </div>
                <div class="stat_line">
                    <p class="title">Прибыльных (%):</p>
                    <p id="stat_percent_profit" class="stat_text_right"></p>
                </div>
                <!-- <div class="stat_reset">
                    <div class="ord_wrap_hidn btn_stat_start_reset" id="btn_stat_start_reset" onclick="switchReset('start')">Очистить историю</div>
                    <div class="ord_wrap_hidn" id="btn_stat_wrap_yes_no" >
                        <div class="title">Вы уверены?</div>
                        <div class="wrap_btns_stat">
                            <a href="/reset_orders/10" class="reset_yes">Да</a>
                            <div class="reset_no" onclick="switchReset('cancel')">Нет</div>
                        </div>
                    </div>
                </div> -->
            </div>
    ...
    <div class="history">
        <div class="header_wrap">
            <p class="title">История сделок</p>
            <div class="right_w">
                <div class="item history_market">
                    <select id="chose_history_market" onchange="history_filter_markets()">
                        <option value="all_history_markets">Выбрать рынок</option>
                        <option value="history_crypto">Крипта</option>
                        <option value="history_forex">Форекс</option>

                    </select>
                </div>
                <div class="item history_market">
                    <select id="chose_history_older" onchange="history_filter_time()">
                        <option value="all">За всё время</option>
                        <option value="24h">За сегодня</option>
                ...
                <div class="item active_item" id = "history_all_orders" onclick="change_history_active_completed('all')">
                    <p>Все</p>
                </div>
                <div class="item " id = "history_disactive_orders" onclick="change_history_active_completed('disactive')">
                    <p>Не активные</p>
                </div>
                <div class="item " id = "history_active_orders" onclick="change_history_active_completed('active')">
                    <p>Активные</p>
                </div>
                <div class="item" id = "history_completed_orders" onclick="change_history_active_completed('completed')">
                    <p>Завершенные</p>
                </div>
        ...
        <div class="history_wrap" id="history_wrap">

        </div>


        <div class="ord_wrap_hidn" id="link_more">
            <a href="#">Показать все сделки</a>
        </div>
    ...
    <x-footer-scripts-calc-app></x-footer-scripts-calc-app>
</x-app-layout>