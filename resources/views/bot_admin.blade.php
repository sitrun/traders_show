    ...
    <div class="row main_bot_view">
        <div class="col-xs-5 col-md-2">
            ...
            <div class="btn-group-vertical" role="group" aria-label="...">
                ...
                <a class="btn btn-default active" href="/bot_admin" role="button">Главная</a>
        ...
        <div class="col-xs-6">
            <h2 class="current_menu">Главная</h2>
            <div class="view_result" id="view_result">
                <table class="table table-striped">
                    ...
                    <tbody>
                        <tr><td>В базе:</td><td>{{$stat->get('count_users')}}</td></tr>
                        <tr><td>Платных:</td><td>{{$stat->get('count_paid')}}</td></tr>
                        <tr><td>Постоянные:</td><td>0</td></tr>
                        <tr><td>Количество администраторов:</td><td>{{$stat->get('count_admins')}}</td></tr>
                        <tr><td>Количество отложенных постов:</td><td>{{$stat->get('count_posts')}}</td></tr>
                    </tbody>
                </table>
            </div>
        </div>
