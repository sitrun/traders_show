<x-app-layout>
<x-slot name="title">Страница вывода всех категорий</x-slot>

    <!-- Контент -->
    <div class="content_wrap">
        <div class="top_nav">
            <p>Страница вывода всех категорий</p>
            <img src="{{ asset('storage/img/arrow_right.png') }}" alt="arrow">
            <p class="black_text">__</p>
        </div>
        ...
        <div class="articles_wrap">
            <a href="{{route('post', 'edication', '1')}}" class="item">
                <div class="top">
