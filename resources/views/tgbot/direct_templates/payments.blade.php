    ...
    <div class="row main_bot_view">
        <div class="col-xs-5 col-md-2">
            ...
            <div class="btn-group-vertical" role="group" aria-label="...">
                ...
                <a class="btn btn-default active" href="/bot_admin/payments" role="button">Оплата</a>
                {{--<div class="btn-group" role="group">
                    <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        Параметры
                        <span class="caret"></span>
        ...
        <div class="col-xs-6">
            <h2 class="current_menu">Платежи</h2>
                ...
                <table class="table table-striped">
                    ...
                    @foreach($data as $el)
                        <tr>
                            <td>{{ $el->user->id }}</td>
                            <td>{{ $el->user_id}}</td>
                            <td>{{ $el->user->username_tg}}</td>
                            <td>
                                Куплено: "{{$el->tariff->name}}"<br>
                                Сумма: {{$el->sum}} {{$el->currency}}<br>
                                Дата платежа: {{$el->payment_date_view}}<br>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
